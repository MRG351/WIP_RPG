...
public class StartOptionsMenu extends GameState {
    ...
    private String[] optionsLabels = {"OPTION1", "OPTION2", "ETC"};
    ...
    private void init() {
        loadImages();
        selector = Selectors.OPTION1.getValue();
    }
    
    private boolean loadImages() {
        images = new OptionsMenuImage[1];
    ...
    private class OptionsMenuImage {
        private BufferedImage image;
        private int x;
        private int y;
        
        public OptionsMenuImage(BufferedImage image, int x, int y) {
            this.image = image;
            this.x = x;
            this.y = y;            
        }
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_UP) {
				selector = (selector + optionsLabels.length - 1) % optionsLabels.length;
			} 
            else if (e.getKeyCode() == KeyEvent.VK_DOWN) {
				selector = (selector + 1) % optionsLabels.length;
			} 
